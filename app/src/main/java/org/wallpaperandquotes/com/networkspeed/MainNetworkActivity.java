package org.wallpaperandquotes.com.networkspeed;
...
import org.wallpaperandquotes.com.networkspeed.adapter.NetworkRecyclerAdapter;
import org.wallpaperandquotes.com.networkspeed.async.HttpHandler;
import org.wallpaperandquotes.com.networkspeed.retrofit.APiService;
import org.wallpaperandquotes.com.networkspeed.retrofit.RetrofitClient;
import org.wallpaperandquotes.com.networkspeed.retrofit.dto.hive.Movie;
import org.wallpaperandquotes.com.networkspeed.retrofit.dto.hive.MoviesResponse;
import org.wallpaperandquotes.com.networkspeed.volley.networking.APIRequest;
import org.wallpaperandquotes.com.networkspeed.volley.networking.Connectivity;
import org.wallpaperandquotes.com.networkspeed.volley.networking.DialogUtil;
import org.wallpaperandquotes.com.networkspeed.volley.networking.RequestCode;
import org.wallpaperandquotes.com.networkspeed.volley.networking.VolleyUtil;
...
//        startActivityForResult(intent, 123);
    ...
    private void stopTimer(int type) {
        switch (type) {
            case TYPE_ASYNC:
                tvAsyncTime.setText(((System.currentTimeMillis() - timeStart) ) + " MilliSecond");
                break;
            case TYPE_VOLLEY:
                tvVolleyTime.setText( ((System.currentTimeMillis() - timeStart)) + " MilliSecond");
                break;
            case TYPE_RETRO:
                tvRetrofitTime.setText(((System.currentTimeMillis() - timeStart)) + " MilliSecond");
                break;
        }
    }
