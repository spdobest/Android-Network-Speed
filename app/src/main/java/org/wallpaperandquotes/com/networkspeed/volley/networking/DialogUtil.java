...
import org.wallpaperandquotes.com.networkspeed.BuildConfig;
import org.wallpaperandquotes.com.networkspeed.R;
...
public class DialogUtil {
    ...
    public static void showNoNetworkAlert(Context ctx) {
        try {
            new android.app.AlertDialog.Builder(ctx).setTitle(R.string.app_name).setMessage("no_internet")
